...
Disasters as floods and landslides have been increasing in the last 20 years around the world. During 2000-2019, 7.348 disaster events occurred compared to 4.212 registered between 1980-1999 (United Nations Environment Programme,2019).
...
One such example is mangroves which act as natural infrastructure that reduce physical exposure to tsunamis. Therefore, through ecosystem management, this crucial natural barrier could also offer socio-economic resilience to people and communities by sustaining local livelihoods (eco-tourism) and providing natural resources (water, food). At the same time, it reduces the intensity of the hazard (Sudmeier-Rieux et al., 2019).
<div/>

## **Ecosystem-based adaptation**

<div style="text-align: justify">
The Convention on Biological Diversity, 2009, defines the concept as *"the use of biodiversity and ecosystem services as part of an overall adaptation strategy to help people adapt to the adverse effects of climate change."*. Consequently, the term relates a long term of environmental management to adapt to climatic variations.

One instance could be resilient crop varieties and integrated water resources management within the agricultural sector; by guaranteeing resourceful cultivation to tackle extreme dry and rainy seasons (Sudmeier-Rieux et al., 2019).

Lastly, the Eco-DRR and the EbA approach aim to achieve similar interventions, for example, sustainable management, conservation, and ecosystem restoration. Nevertheless, there are some differences to take into account. Firstly, EbA is more related to ecosystem services and biodiversity rather than Eco-DRR. Whereas, Eco-DRR does not focus primarily on protecting biodiversity but on increasing resilience on people to reduce risks (Sudmeier-Rieux et al., 2019).
<div/>

## **Projects sponsored from international organizations**

<div style="text-align: justify">
Nowadays, the United Nations Environment Programme sponsors 45 projects related to EbA and some with Eco-DRR around the world with significant results. Most of them are carried out in Latinamerica (Mexico and Jamaica), Africa (Mozambique and Tanzania), Asia (Nepal and Bangladesh), and Europe (Albania) **(Figure 1).** 
...
![](C:\Users\fabia\Documents\TRABAJOS MSC\SEMANA 2\Introduction to Programming and Statistics for Remote Sensing and GIS\Tasks\Projects_around_the_world.png){width=70%}
<br>
...
Nehren, U., Sudmeier-Rieux, K., Sandholz, S., Estrella,
M., Lomarda, M. and T. Guillén. 2014. The Ecosystem-Based Disaster
